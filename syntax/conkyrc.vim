...
syn keyword ConkyrcSetting
      ...
      \ mldonkey_login mldonkey_password mpd_host mpd_port mpd_password out_to_x
      \ net_avg_samples override_utf8_locale own_window own_window_transparent
      \ own_window_colour own_window_type pad_percents stippled_borders total_run_times
      \ update_interval uppercase use_spacer use_xft short_units xftfont xftalpha
      \ color1 color2 color2 color4 color5 out_to_console draw_graph_borders own_window_hints

syn keyword ConkyrcConstant 
      \ yes no top_left tl top_right tr bottom_left bl bottom_right br none
      \ black white grey red yellow green blue orange purple cyan magenta
...
syn keyword ConkyrcVarName contained nextgroup=ConkyrcNumber,ConkyrcColour skipwhite
      \ addr acpiacadapter acpifan acpitemp acpitempf adt746xcpu downspeedgraph
